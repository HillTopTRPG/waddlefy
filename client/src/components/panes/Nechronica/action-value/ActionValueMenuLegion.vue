  ...
  <v-menu :close-on-content-click="false" scroll-strategy="close">
    <template #activator="{ props }">
      <v-btn variant="text" class="text-body-1 px-0" v-bind="props">
        <div class="d-flex flex-row align-end border border-b-md border-opacity-100 border-t-0 border-s-0 border-e-0">
        ...
        <div
          class="d-flex flex-row align-end pl-2 border border-b-md border-opacity-100 border-t-0 border-s-0 border-e-0"
        >
